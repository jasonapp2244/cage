...
class CompanyNameView extends StatefulWidget {
  const CompanyNameView({super.key});

  @override
  State<CompanyNameView> createState() => _CompanyNameViewState();
}

class _CompanyNameViewState extends State<CompanyNameView> {
