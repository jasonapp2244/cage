...
class ContactEmailView extends StatefulWidget {
  const ContactEmailView({super.key});

  @override
  State<ContactEmailView> createState() => _ContactEmailViewState();
}

class _ContactEmailViewState extends State<ContactEmailView> {
