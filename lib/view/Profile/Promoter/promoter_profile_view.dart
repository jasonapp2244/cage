              ...
              children: [
                ...
                StreamBuilder<UserModel>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    print('Promoter Data:');
                    print('- Company Name: ${promoter.companyName}');
                    print('- Promoter Name: ${promoter.prompterName}');
                    print('- Contact Email: ${promoter.contactEmail}');
                    print('- Contact Number: ${promoter.contactNumber}');
                    print('- Location: ${promoter.location}');
                    print('- Number of Events: ${promoter.numberOfEvents}');
                    print('- Company About: ${promoter.companyAbout}');
