...
class WhoThepromoterView extends StatefulWidget {
  const WhoThepromoterView({super.key});

  @override
  State<WhoThepromoterView> createState() => _WhoThepromoterViewState();
}

class _WhoThepromoterViewState extends State<WhoThepromoterView> {
  final TextEditingController fullNameController = TextEditingController();
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  final FocusNode _promoterFocusNode = FocusNode();
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 300), () {
      if (mounted) {
        FocusScope.of(context).requestFocus(_promoterFocusNode);
      }
    });
  }
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return "Please Enter Who's The Promoter";
                          }
                          return null;
                        },
...
//                       "Please Enter Who’s The Promoter",
//                       context,
//                     );
//                   } else {
//                     Navigator.pushNamed(context, RoutesName.ContactEmailView);
