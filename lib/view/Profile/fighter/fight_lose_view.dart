...
class FightLoseView extends StatefulWidget {
  ...
  @override
  State<FightLoseView> createState() => _FightLoseViewState();
}

class _FightLoseViewState extends State<FightLoseView> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              SizedBox(height: Responsive.h(2)),
                ...
                const Text(
                  'Mention the number of official losses in your fight record.',
